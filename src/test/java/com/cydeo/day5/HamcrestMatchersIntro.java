...
public class HamcrestMatchersIntro {
    ...
    public void testCollection(){
        ...
        List<Integer> listOfNumbers= Arrays.asList(1,3,4,23,6,98,54,98,43,27);
        ...
        //check f the list has items, 1,3,4
        assertThat(listOfNumbers,hasItems(1,3,4));
