...
public class ORDSApiWithJsonPath extends HrTestBase {
    ...
    public void test2() {
        ...
        List<String> namesThatMoreThan10000Salary = jsonPath.getList("items.findAll {it.salary>=10000}.first_name");
        System.out.println(namesThatMoreThan10000Salary);

        //get the max salary first_name
        String kingFirstName=jsonPath.getString("items.max {it.salary}.first_name");
        String kingNamePathMethod=response.path("items.max {it.salary}.first_name");
        System.out.println("kingFirstName = " + kingFirstName);
        System.out.println("kingNamePathMethod = " + kingNamePathMethod);
