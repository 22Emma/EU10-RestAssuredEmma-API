...
//   save base url inside this variable so that we dont need to type each http method
        baseURI="http://54.158.220.79:8000";
        baseURI="http://54.158.220.79:1000/ords/hr"; // for ords hr
    }
 ...
 /*
    ...
    public void test1(){
     ...
     assertEquals("application/json",response.header("Content-Type"));//you can get like this instead od contentType()
